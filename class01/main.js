...
// 사용자는 컴퓨터에서 웹에 접근 => 서버에 최초 요청(Request) =>
// 최초 응답(Response) 기본적인 구조를 담은 HTML이 응답으로 전달된다. =>
// 추가 요청(CSS, JS, 이미지, 동영상 등) => 추가 응답
...
// 1-3차시
// 자바스크립트 선행
console.log('Hello World!') // => index.html 파일 만들고, import해서 먼저 테스트
