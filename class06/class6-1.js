...
// 자바스크립트 함수는 매개변수화(parameterized) 됩니다. 함수 정의에는 매개변수(paramter)라고 불리는 식별자 리스트가 있는데 이들은 함수 바디에서 로컬변수처럼 동작합니다.
// 함수를 호출할 때는 매개변수에 값을 전달하는데 이를 인자(agument)라고 합니다.

// 1. function 함수
// 함수선언은 function 키워드 뒤에 다음 세 가지 구성 요소를 씁니다.
// - 함수 이름이 될 식별자. 이름은 하수 선언에서 뺄 수 없는 부분입니다. 이 이름은 변수 이름으로 쓰이며, 새로 정의된 함수 객체가 이 변수에 할당됩니다
